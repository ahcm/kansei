...
{
    Ok(Value::Float { value: num_arg(args, 0, "Math.sin")?.sin(), kind: crate::ast::FloatKind::F64 })
}

fn native_math_cos(args: &[Value]) -> Result<Value, String>
{
    Ok(Value::Float { value: num_arg(args, 0, "Math.cos")?.cos(), kind: crate::ast::FloatKind::F64 })
}

fn native_math_tan(args: &[Value]) -> Result<Value, String>
{
    Ok(Value::Float { value: num_arg(args, 0, "Math.tan")?.tan(), kind: crate::ast::FloatKind::F64 })
}

fn native_math_asin(args: &[Value]) -> Result<Value, String>
{
    Ok(Value::Float { value: num_arg(args, 0, "Math.asin")?.asin(), kind: crate::ast::FloatKind::F64 })
}

fn native_math_acos(args: &[Value]) -> Result<Value, String>
{
    Ok(Value::Float { value: num_arg(args, 0, "Math.acos")?.acos(), kind: crate::ast::FloatKind::F64 })
}

fn native_math_atan(args: &[Value]) -> Result<Value, String>
{
    Ok(Value::Float { value: num_arg(args, 0, "Math.atan")?.atan(), kind: crate::ast::FloatKind::F64 })
}

fn native_math_log(args: &[Value]) -> Result<Value, String>
{
    Ok(Value::Float { value: num_arg(args, 0, "Math.log")?.ln(), kind: crate::ast::FloatKind::F64 })
}

fn native_math_exp(args: &[Value]) -> Result<Value, String>
{
    Ok(Value::Float { value: num_arg(args, 0, "Math.exp")?.exp(), kind: crate::ast::FloatKind::F64 })
}
...
fn native_math_pow(args: &[Value]) -> Result<Value, String>
{
    ...
    Ok(Value::Float { value: base.powf(exp), kind: crate::ast::FloatKind::F64 })
}

fn native_math_sqrt(args: &[Value]) -> Result<Value, String>
{
    Ok(Value::Float { value: num_arg(args, 0, "Math.sqrt")?.sqrt(), kind: crate::ast::FloatKind::F64 })
}
